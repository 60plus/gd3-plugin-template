            ...
            "settings": [
                {
                    ...
                    "hint": "Number of floating background particles",
                    "type": "select",
                    "default": "6",
                    "options": ["0", "3", "6", "12"],
                ...
                },
                {
                    "key": "glowIntensity",
                    "label": "Neon Glow",
                    "hint": "Intensity of neon glow effects on cards and text",
                    "type": "range",
                    "default": 1,
                    "min": 0,
                    "max": 2,
                ...
                },
                {
                    "key": "glassBlur",
                    "label": "Glass Blur",
                    "hint": "Backdrop blur strength for glass panels",
                    "type": "range",
                    "default": 20,
                    "min": 0,
                    "max": 60,
                ...
                },
                {
                    ...
                    "hint": "Subtle CRT-style horizontal scanline effect",
                    "type": "toggle",
                    "default": False,
                    "cssVar": "--nh-scanlines",
                },
                {
                    "key": "bgSpeed",
                    "label": "BG Animation Speed",
                    "hint": "Speed of the background gradient shift animation",
                    "type": "select",
                    "default": "20s",
                    "options": ["10s", "20s", "40s", "0s"],
                    "optionLabels": ["Fast", "Normal", "Slow", "Off"],
                    "cssVar": "--nh-bg-speed",
                },
            ],
        }
